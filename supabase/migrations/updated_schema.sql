...
CREATE TYPE trigger_type       AS ENUM (
    'rainfall', 'extreme_heat', 'flood',
    'cold_fog', 'civil_unrest', 'platform_outage'
);
...
-- =========================================
-- INSURANCE PLANS
-- (defined before workers so worker_insurance can reference both)
-- =========================================
...
-- =========================================
-- WORKER INSURANCE
-- (after workers, since it references workers.id)
-- =========================================
...
-- =========================================
-- DISRUPTION EVENTS
-- (raw sensor / feed data before classification)
-- =========================================
...
-- =========================================
-- DISRUPTIONS
-- (classified & confirmed disruptions)
-- =========================================
...
CREATE TABLE admins (
    ...
    CONSTRAINT check_admin_role CHECK (role IN ('zonal_admin', 'control_admin'))
);
...
CREATE INDEX idx_disruptions_trigger ON disruptions(trigger_type);
...
CREATE INDEX idx_activity_worker     ON worker_activity_logs(worker_id);
CREATE INDEX idx_activity_recorded   ON worker_activity_logs(recorded_at);
